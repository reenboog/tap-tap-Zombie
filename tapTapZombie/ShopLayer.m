...
- (id) initWithCurrentPageItem: (NSString *) itemName;
{
    if(self = [super init])
    {
        ...
        // coins label
        coinsLabel = [CCLabelBMFontNumeric labelWithValue: [Settings sharedSettings].coins fntFile: kDefaultGameFont];
...
- (CCMenuItem *) pageItemWithShopItem: (ShopItem *) shopItem
{
    ...
    // header
    CCLabelBMFont *headerLabel = [CCLabelBMFont labelWithString: shopItem.header fntFile: kDefaultGameFont];
    headerLabel.anchorPoint = ccp(0, 0.5f);
    headerLabel.position = ccp(14.0f, itemHeight/2 + 16.0f);
    [pageItem addChild: headerLabel];
    
    // description
    CCLabelBMFont *descriptionLabel = [CCLabelBMFont labelWithString: shopItem.desc fntFile: kDefaultGameFont];
    ...
    CCLabelBMFont *costLabel = [CCLabelBMFont labelWithString: costLabelText fntFile: kDefaultGameFont]; 
    ...
    if(!shopItem.isMoneyPack)
    {
        ...
        CCLabelBMFont *amountLabel = [CCLabelBMFont labelWithString: amountLabelText fntFile: kDefaultGameFont];
